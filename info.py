...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '7159500227').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002466783986').split()]
...
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'kishaaheer')
